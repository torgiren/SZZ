...
PERF="overall=$overall%;$OVER_WARN;$OVER_CRIT;0;100 user=$user%;$USER_WARN;$USER_CRIT;0;100 iowait=$iowait%;$IO_WARN;$IO_CRIT;0;100 nice=$nice%;100;100;0;100 irc=$irq%;100;100;0;100 softirq=$softirq%;100;100;0;100"
echo $MSG"|"$PERF
exit $RESULT
