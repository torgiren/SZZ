...
PERF="overall=$overall%;$OVER_WARN;$OVER_CRIT;0; user=$user%;$USER_WARN;$USER_CRIT;0; iowait=$iowait%;$IO_WARN;$IO_CRIT;0; nice=$nice1%;100;100;0; irq=$irq%;100;100;0; softirq=$softirq%;100;100;0;"
echo $MSG"|"$PERF
exit $RESULT
