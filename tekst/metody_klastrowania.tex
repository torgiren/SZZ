...
\lstinputlisting[caption=rekord CNAME]{lst/rr_cname.lst}
...
\lstinputlisting[caption=dig rr.mgr.fabrykowski.pl +short]{lst/rr_dig.shell}
...
\begin{itemize}
	...
	\lstinputlisting[caption=nginx upstream]{lst/nx_weight.conf}
