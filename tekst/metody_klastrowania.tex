...
Jednym ze sposobów jest użycie \texttt{ARPtables}, listing \ref{lst_lvs_addr_real}
\lstinputlisting[caption=konfiguracja adresacji dla real servera,label=lst:lvs_addr_root]{lst/lvs_addr_real}
